...
my_dataset_path = 'H:\Msc Ai\Term2\AI-4-Media-23-24\AI4M-miniproject\data_folder'
# Create new folder
# os.mkdir(my_dataset_path)

source_directory = r'H:\Msc Ai\Term2\AI-4-Media-23-24\AI4M-miniproject\cubicasa5k\high_quality\17'

# Make a series of file names
file_names = os.listdir(source_directory)

target_directory = os.path.join(my_dataset_path, my_dataset_path)
...
for file_name in file_names:
    ...
    if file_name_df.str.contains("original").item():
    ...
    # https://pandas.pydata.org/docs/reference/api/pandas.Series.bool.html
        ...
        target_directory = os.path.join(my_dataset_path, file_name)
