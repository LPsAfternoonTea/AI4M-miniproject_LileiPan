...
class Generator(nn.Module):
    # definate z_dim, which is Size of latent dimension
    # definate n_f_maps, which is Number of convolutional feature maps in model
    # definate num_channels, which is Number of channels in the iamge (RGB)
    def __init__(self, z_dim, n_f_maps, num_channels):
        super(Generator, self).__init__()
        
        # definate 4 convs, size of kernel, stride and padding
